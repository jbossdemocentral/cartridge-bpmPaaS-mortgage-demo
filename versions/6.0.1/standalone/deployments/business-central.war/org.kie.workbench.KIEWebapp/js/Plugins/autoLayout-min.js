...
this.facade.offer({name:"AutoLayout",functionality:this.automatic_layout.bind(this),group:"Alignment",icon:ORYX.BASE_FILE_PATH+"images/auto_layout.png",description:"automatic layouting",index:0,minShape:0,maxShape:0});
...
},automatic_layout:function(){Ext.Msg.confirm(ORYX.I18N.Oryx.title,"It is recommended to save the current model before running the automatic layouting, since it may produce unwanted results!\nStart layouting?",this._automatic_layout,this)
...
}else{Ext.Msg.alert(ORYX.I18N.Oryx.title,"An error occurred in the server:\n"+this.returned_layout.error)
