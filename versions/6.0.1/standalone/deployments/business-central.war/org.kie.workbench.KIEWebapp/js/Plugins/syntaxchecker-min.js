...
var c=true;
new Ajax.Request(ORYX.PATH+"syntaxcheck",{method:"POST",asynchronous:false,parameters:{data:d,profile:ORYX.PROFILE,pp:ORYX.PREPROCESSING,uuid:ORYX.UUID},onSuccess:function(e){var f=(e&&e.responseText?e.responseText:"{}").evalJSON();
