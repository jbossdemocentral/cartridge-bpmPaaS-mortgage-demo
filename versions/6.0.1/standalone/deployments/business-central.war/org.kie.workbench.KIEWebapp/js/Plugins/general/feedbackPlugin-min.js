...
},showWindow:function(){var a=new Ext.Window({title:ORYX.I18N.Feedback.pTitle,width:"50%",closable:true,items:[{xtype:"form",url:ORYX.CONFIG.ROOT_PATH+"feedback",frame:true,labelAlign:"top",items:[{layout:"column",items:[{columnWidth:0.5,layout:"form",items:{xtype:"textfield",name:"name",fieldLabel:ORYX.I18N.Feedback.pName,anchor:"98%"}},{columnWidth:0.5,layout:"form",items:{xtype:"textfield",name:"email",fieldLabel:ORYX.I18N.Feedback.pEmail,vtype:"email",anchor:"100%"}}]},{xtype:"combo",anchor:"100%",name:"subject",store:new Ext.data.SimpleStore({fields:["title"],data:[["[Feedback] "],["[Bug Report] "],["[Feature Request] "]]}),allowBlank:false,displayField:"title",mode:"local",typeAhead:true,triggerAction:"all",fieldLabel:ORYX.I18N.Feedback.pSubject+" *"},{xtype:"textarea",name:"description",allowBlank:false,fieldLabel:ORYX.I18N.Feedback.pMsg+" *",emptyText:ORYX.I18N.Feedback.pEmpty,height:200,anchor:"100%"},{xtype:"checkbox",boxLabel:ORYX.I18N.Feedback.pAttach+' <img src="'+ORYX.CONFIG.ROOT_PATH+'/images/information.png" ext:qtip="'+ORYX.I18N.Feedback.pAttachDesc+'"/>',hideLabel:true,checked:true,listeners:{check:function(d,b){var c=a.find("itemId","hiddenModel")[0];
